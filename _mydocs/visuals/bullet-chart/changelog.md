...
Bullet Chart uses **Power BI Custom Visuals API v5.11.0**, which requires:
- Power BI Service
...
- Fix wrong scrollable legend icons rendering
- Fix license information display in settings
