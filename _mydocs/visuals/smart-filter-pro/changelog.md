...
Smart Filter Pro uses Power BI Custom Visuals API v1.13.0, which requires:
- Power BI Service 
- **Power BI Desktop July 2018** or later 
- **Power BI Report Server January 2019** or later
