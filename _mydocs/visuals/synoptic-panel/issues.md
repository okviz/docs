...
**Error Message**: *Cannot display maps without data points.*
...
**Error Message**: *The column in the Legend field well is also used as Category and is not the first column in the Category field well. Reorder the columns in the Category field well or change legend to fix this issue.*
...
**Error Message**: *The map is missing a category. Please select a category to continue.*
...
**Error Message**: *The requested operation is not allowed.*

This error occurs when you try to perform an operation in [My Storage](./features/my-storage.md) that is not permitted due to restrictions or permissions.

**Try To**: Ensure that you have the necessary permissions to perform the operation. If the problem persists, contact support.

## Retry Later

**Error Message**: *License information is not yet available. Please try to connect to My Storage later.*

This error occurs when you try to access [My Storage](./features/my-storage.md) but the license information is not yet available, which can happen if there are temporary issues with the licensing service.

**Try To**: Wait for a while and try to access My Storage again later. If the problem persists, contact support.
