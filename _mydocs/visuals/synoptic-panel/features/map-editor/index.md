...
> **NOTE:** Map Editor is different from [Synoptic Designer](../../../../synoptic-designer/index.md). Map Editor configures maps inside the Power BI visual. Synoptic Designer creates and edits SVG map geometry, tracing images, formatting, and SVG export before the map is imported into Synoptic Panel.
