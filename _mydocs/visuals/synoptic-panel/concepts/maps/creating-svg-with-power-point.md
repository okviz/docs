...
author:             Victor Rivas
---
[Microsoft PowerPoint](https://www.microsoft.com/en-us/microsoft-365/powerpoint?market=en) is primarily a presentation tool, but it includes a capable vector drawing engine. For simple layouts such as floor plans, rack diagrams, or schematic maps, you can draw shapes on a slide and export the slide as an SVG file that Synoptic Panel can render as a map.
...
3. Draw each interactive area as its own shape. Basic shapes such as rectangles, lines, and polygons export predictably.
    ...
    <img src="images/shapes-in-powerpoint.png" width="300">
...
>> **NOTE:** Do not export by selecting all objects, then right clicking and using **Save as Picture**. That method can change coordinates and cause elements to shift, which can break alignment and selection in Synoptic Panel.

<img src="images/save-as-svg-in-powerpoint.png" width="500" class="naked">

## Bind Shapes in Synoptic Panel
...
> See [Data Binding](../data-binding) for more details on how binding works.
...
PowerPoint is workable, but it becomes time consuming when you have many areas and you want automatic binding. Other vector editors let you control layer and object names, which map directly to SVG ids when exported, making it easier to align ids with your Power BI category values.

For more complex maps, consider using [other tools](./creating-svg.md#creating-with-a-graphic-editor) like Figma or Adobe Illustrator.
